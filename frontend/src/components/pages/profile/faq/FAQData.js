...
function FAQData () {
  const [faqs, setfaqs] = useState([
    ...
    },
    {
        ...
        answer: 'We have the the Reactangle Series, Round Series, the vertical series, the Bowl series,and other products too',
        open: false
    },
    {
      question: 'What are yor rates for shipping and how much time it will take for shipping',
      answer: 'The shipping charges are differnet for differnet prodcuts and it may take upto 3 days for shipping',
      open: false
    },
    {
